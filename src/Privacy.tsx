  ...
  return (
    <Box px={5} mt={5}>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Sone Taran, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Code Implants Software Technologies Pvt.
            Ltd., Pimpri-Chinchwad, Maharashtra.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>By email: codeimplants@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href="https://codeimplants.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://codeimplants.com/
            </a>
          </p>
        </li>
      </ul>
